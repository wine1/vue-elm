...
// 搜索地址
export const searchPlace = (city_id, value) =>
  fetch("/v1/pois", {
    type: "search"
  });
...
//获取商家详情
export const restaurantDetails = (shopid, latitude, longitude) => fetch('/shopping/restaurant/' + shopid, {
  latitude,
...
// 获取评价列表
export const getRatingList = (shopid, tag_name, offset) => fetch('ugc/v2/restaurants' + shopid + 'rating', {
  has_content: true,
  offset,
  limit: 10,
  tag_name
